...
<head>
    ...
    <title>SIKPD - Form Penyewaan</title>
        ...
        <div class="container">
            <nav class="breadcrumbs">
                <ol>
                    ...
                    <li class="current">Form Penyewaan</li>
                </ol>
            </nav>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-title">
                        <h2>Form Penyewaan Alat dan Bahan</h2>
                    </div>
                    <form action="proses_sewa.php" method="post">
                    <input type="hidden" name="id_alatbahan" value="<?php echo htmlspecialchars($id_alatbahan); ?>">
                    <input type="hidden" name="nama_penyewa" value="<?php echo htmlspecialchars($_SESSION['nama_petani']); ?>">
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Penyewa</label>
                            <input type="text" class="form-control" id="nama" name="nama_penyewa_display" value="<?php echo htmlspecialchars($_SESSION['nama_petani']); ?>" readonly>
                        </div>
